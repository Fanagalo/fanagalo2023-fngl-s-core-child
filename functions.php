 ...
 * TO DO: the font section should become a separate file that serves fonts in frontend aznd backend
*/
...
require get_stylesheet_directory() . '/inc/template-functions.php';               // Custom template tags for this theme.
